...
function HowItWorks() {
  ...
  return (
    <section className="mt-32 max-md:mt-10">
      <h2 className="text-lg font-medium text-orange-400">How to work</h2>
      <h3 className="text-4xl font-bold text-black max-md:max-w-full">Food Us An Important Part Of A Balanced Diet</h3>
